...
import com.ehs.mihonline.SpringRestAngularApplication;

@RunWith(SpringRunner.class)
@SpringBootTest(classes = SpringRestAngularApplication.class, webEnvironment = WebEnvironment.DEFINED_PORT)
public class StudentServiceIntegrationTest {

    private static final String ENDPOINT = "http://localhost:8181/student/get";

    @Test
    public void givenRequestForStudents_whenPageIsOne_expectContainsNames() {
    	
       // given().params("page", "0", "size", "2").get(ENDPOINT).then().assertThat().body("content.name", hasItems("veera", "raja"));
    }
